...
<html>
    ...
    <body>
        ...
        <form action="/edit">
            <div class="trow">
                <label for="idInput" title="id">ID</label>
                <input type="text" id="idInput" value="0">
            </div>
            <div class="trow">
                <label for="dateInput" title="d">Date</label>
                <input type="date" id="dateInput">
            </div>
            <div class="trow">
                <label for="durationInput" title="d2">Duration</label>
                <input type="text" id="durationInput" value="0">
            </div>
